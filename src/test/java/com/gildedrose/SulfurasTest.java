...
public class SulfurasTest {
    ...
    final static String itemName=GildedRose.SULFURAS;

    @Test
    void should_Return_SellIn_One_If_SellIn_Is_One_And_Return_Quality_One_If_Quality_Is_One(){
        GildedRose gildedRose=new GildedRose(new Item[] {new Item(itemName, 1, 1) });
    ...
    void should_Return_false_If_SellIn_After_Update_Has_Changed(){
        ...
        gildedRose.updateQuality();
        Assertions.assertNotEquals(new Item(itemName, 1, 2).sellIn, gildedRose.items[0].sellIn);
    }
    ...
    void should_Return_false_If_Quality_After_Update_Has_Changed(){
        GildedRose gildedRose=new GildedRose(new Item[] {new Item(itemName, 0, 0) });
        gildedRose.updateQuality();
        Assertions.assertNotEquals(new Item(itemName, 0, 2).quality, gildedRose.items[0].quality);
    }
    ...
    void should_Not_IncreaseQuality_If_Quality_Is_50(){
        ...
        gildedRose.updateQuality();
        checkItemEqual(new Item(itemName, 3, 50),gildedRose.items[0]);
    }

    @Test
    void should_Return_True_If_Quality_Is_Above_50(){
        GildedRose gildedRose=new GildedRose(new Item[] {new Item(itemName, 3, 60) });
        gildedRose.updateQuality();
        checkItemEqual(new Item(itemName, 3, 60),gildedRose.items[0]);
    }
    ...
    void should_Not_DecreaseQuality(){
        ...
        gildedRose.updateQuality();
        checkItemEqual(new Item(itemName, 0, 50),gildedRose.items[0]);
    }
